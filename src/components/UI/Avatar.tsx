...
const Avatar: React.FC<AvatarProps> = ({
	...
	return (
		<div
			className="w-26 h-26 overflow-hidden shadow"
			style={{
				backgroundImage: `url(${resolvedFrameUrl})`,
				backgroundSize: 'cover'
			}}
		>
			<span className="flex h-full w-full items-center justify-center text-5xl text-gray-400">
				<Image src={avatarUrl} alt="Avatar" width={93} height={93} />
			</span>
		</div>
	)
}
