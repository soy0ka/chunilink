...
const Honner: React.FC<HonnerProps> = ({ children, type = "GOLD" }) => (
  <div
    className="rounded-md px-3 py-1 text-sm font-bold shadow-sm tracking-wide"
    style={{
      backgroundImage: `url('${HonnerBackground[type]}')`,
